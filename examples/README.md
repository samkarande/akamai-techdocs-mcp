...
| 4 | [`04-lke-autoscaling-cluster`](04-lke-autoscaling-cluster/) | Terraform (`linode/linode`) + k8s manifest | An autoscaling LKE cluster (desired 2 nodes) in `us-iad`, with a sample workload pinned to 2 pods/node |
